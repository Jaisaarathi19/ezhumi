...
export default function Home() {
  ...
  return (
    <main className="relative">
      ...
      <section id="themes" className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-black text-white px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white">{t('themes.title')}</h2>
            <p className="text-xl text-green-200">{t('themes.subtitle')}</p>
          </div>

          <div className="space-y-6">
            {/* Category 1: Crop Health, Water, and Climate */}
            <div className={`bg-green-800/20 backdrop-blur-sm border-2 border-green-400/30 rounded-xl transition-all duration-500 ease-in-out hover:border-green-300 hover:shadow-2xl hover:shadow-green-500/20 ${
              expandedCategories.has('cropHealth') ? 'shadow-2xl shadow-green-500/30 border-green-300' : ''
            }`}>
              <div 
                className="flex items-center justify-between p-6 cursor-pointer group"
                onClick={() => toggleCategory('cropHealth')}
              >
                <div className="flex items-center space-x-4">
                  <div className={`w-4 h-4 rounded-full transition-all duration-300 ${
                    expandedCategories.has('cropHealth') ? 'bg-green-400 shadow-lg shadow-green-400/50' : 'bg-green-500'
                  }`}></div>
                  <h3 className="text-2xl font-bold text-green-200 group-hover:text-white transition-colors">
                    {t('themes.categories.cropHealth.title')}
                  </h3>
                </div>
                <div className="flex items-center space-x-4">
                  <span className="text-green-400 text-sm font-medium bg-green-400/10 px-3 py-1 rounded-full border border-green-400/30">
                    8 Problems
                  </span>
                  <div className={`transform transition-transform duration-300 ${
                    expandedCategories.has('cropHealth') ? 'rotate-45' : 'rotate-0'
                  }`}>
                    <div className="w-6 h-6 border-2 border-green-400 rounded-sm flex items-center justify-center">
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-in-out ${
                expandedCategories.has('cropHealth') ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
              }`}>
                <div className="px-6 pb-6 border-t border-green-500/30">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6">
                    {(t('themes.categories.cropHealth.problems', { returnObjects: true }) as Problem[]).map((problem: Problem) => (
                      <div 
                        key={problem.id} 
                        className="bg-green-900/40 border border-green-500/20 rounded-lg p-4 hover:border-green-400/40 hover:bg-green-800/40 transition-all duration-300 cursor-pointer group transform hover:scale-105"
                      >
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <span className={`px-2 py-1 rounded text-xs font-medium ${
                            problem.type === 'Software' 
                              ...
                              : 'bg-green-700/30 text-green-200 border border-green-600/50'
                          }`}>
                            {problem.type}
                          </span>
                        </div>
                        <p className="text-sm text-green-100/80 leading-relaxed group-hover:text-green-100/90 transition-colors">
                          {problem.description}
                        </p>
                      </div>
                    ))}
            ...
            <div className={`bg-green-800/20 backdrop-blur-sm border-2 border-green-400/30 rounded-xl transition-all duration-500 ease-in-out hover:border-green-300 hover:shadow-2xl hover:shadow-green-500/20 ${
              expandedCategories.has('postHarvest') ? 'shadow-2xl shadow-green-500/30 border-green-300' : ''
            }`}>
              <div 
                className="flex items-center justify-between p-6 cursor-pointer group"
                onClick={() => toggleCategory('postHarvest')}
              >
                <div className="flex items-center space-x-4">
                  <div className={`w-4 h-4 rounded-full transition-all duration-300 ${
                    expandedCategories.has('postHarvest') ? 'bg-green-400 shadow-lg shadow-green-400/50' : 'bg-green-500'
                  }`}></div>
                  <h3 className="text-2xl font-bold text-green-200 group-hover:text-white transition-colors">
                    {t('themes.categories.postHarvest.title')}
                  </h3>
                </div>
                <div className="flex items-center space-x-4">
                  <span className="text-green-400 text-sm font-medium bg-green-400/10 px-3 py-1 rounded-full border border-green-400/30">
                  ...
                  <div className={`transform transition-transform duration-300 ${
                    expandedCategories.has('postHarvest') ? 'rotate-45' : 'rotate-0'
                  }`}>
                    <div className="w-6 h-6 border-2 border-green-400 rounded-sm flex items-center justify-center">
                      <span className="text-green-400 font-bold text-lg">+</span>
                    </div>
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-in-out ${
                expandedCategories.has('postHarvest') ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
              }`}>
                <div className="px-6 pb-6 border-t border-green-500/30">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6">
                    {(t('themes.categories.postHarvest.problems', { returnObjects: true }) as Problem[]).map((problem: Problem) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <span className="px-2 py-1 rounded text-xs font-medium bg-green-700/30 text-green-200 border border-green-600/50">
                            {problem.type}
                          </span>
                        </div>
                        <p className="text-sm text-green-100/80 leading-relaxed group-hover:text-green-100/90 transition-colors">
            ...
            <div className={`bg-green-800/20 backdrop-blur-sm border-2 border-green-400/30 rounded-xl transition-all duration-500 ease-in-out hover:border-green-300 hover:shadow-2xl hover:shadow-green-500/20 ${
              expandedCategories.has('mechanization') ? 'shadow-2xl shadow-green-500/30 border-green-300' : ''
            }`}>
              <div 
                className="flex items-center justify-between p-6 cursor-pointer group"
                onClick={() => toggleCategory('mechanization')}
              >
                <div className="flex items-center space-x-4">
                  <div className={`w-4 h-4 rounded-full transition-all duration-300 ${
                    expandedCategories.has('mechanization') ? 'bg-green-400 shadow-lg shadow-green-400/50' : 'bg-green-500'
                  }`}></div>
                  <h3 className="text-2xl font-bold text-green-200 group-hover:text-white transition-colors">
                    {t('themes.categories.mechanization.title')}
                  </h3>
                </div>
                <div className="flex items-center space-x-4">
                  <span className="text-green-400 text-sm font-medium bg-green-400/10 px-3 py-1 rounded-full border border-green-400/30">
                  ...
                  <div className={`transform transition-transform duration-300 ${
                    expandedCategories.has('mechanization') ? 'rotate-45' : 'rotate-0'
                  }`}>
                    <div className="w-6 h-6 border-2 border-green-400 rounded-sm flex items-center justify-center">
                      <span className="text-green-400 font-bold text-lg">+</span>
                    </div>
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-in-out ${
                expandedCategories.has('mechanization') ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
              }`}>
                <div className="px-6 pb-6 border-t border-green-500/30">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6">
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <span className={`px-2 py-1 rounded text-xs font-medium border ${
                            problem.type === 'Hardware + Software' 
                              ? 'bg-green-600/30 text-green-100 border-green-500/60' 
            ...
            <div className={`bg-green-800/20 backdrop-blur-sm border-2 border-green-400/30 rounded-xl transition-all duration-500 ease-in-out hover:border-green-300 hover:shadow-2xl hover:shadow-green-500/20 ${
              expandedCategories.has('knowledge') ? 'shadow-2xl shadow-green-500/30 border-green-300' : ''
            }`}>
              <div 
                className="flex items-center justify-between p-6 cursor-pointer group"
              ...
              >
                <div className="flex items-center space-x-4">
                  <div className={`w-4 h-4 rounded-full transition-all duration-300 ${
                    expandedCategories.has('knowledge') ? 'bg-green-400 shadow-lg shadow-green-400/50' : 'bg-green-500'
                  }`}></div>
                  <h3 className="text-2xl font-bold text-green-200 group-hover:text-white transition-colors">
                    {t('themes.categories.knowledge.title')}
                  </h3>
                </div>
                <div className="flex items-center space-x-4">
                  <span className="text-green-400 text-sm font-medium bg-green-400/10 px-3 py-1 rounded-full border border-green-400/30">
                  ...
                  <div className={`transform transition-transform duration-300 ${
                    expandedCategories.has('knowledge') ? 'rotate-45' : 'rotate-0'
                  }`}>
                    <div className="w-6 h-6 border-2 border-green-400 rounded-sm flex items-center justify-center">
                      <span className="text-green-400 font-bold text-lg">+</span>
                    </div>
              ...
              <div className={`overflow-hidden transition-all duration-500 ease-in-out ${
                expandedCategories.has('knowledge') ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
              }`}>
                <div className="px-6 pb-6 border-t border-green-500/30">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6">
          ...
          <div className="text-center mt-12">
            <p className="text-green-200 mb-6 text-lg">{t('themesCallToAction.readyText')}</p>
            <a href="/register">
              <button className="px-8 py-4 rounded-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-400 hover:to-green-500 text-white font-medium shadow-lg hover:shadow-xl hover:shadow-green-500/30 transition-all duration-300 transform hover:-translate-y-1">
                {t('themesCallToAction.registerButton')}
              </button>
            </a>
          </div>
        </div>
      ...
      <section id="faqs" className="min-h-screen bg-gradient-to-br from-green-100 via-white to-green-50 text-green-900 flex items-center justify-center px-8 py-16">
        <div className="max-w-4xl w-full relative">
          ...
          <div className="space-y-6 relative z-10">
            {Object.entries(t('faqs.questions', { returnObjects: true }) as Record<string, { question: string; answer: string }>).map(([key, faq]) => (
              <div key={key} className="bg-white/70 backdrop-blur-sm rounded-lg border border-green-200 shadow-md hover:shadow-lg transition-all duration-300">
                <details className="group">
                  ...
                  <div className="px-6 pb-6">
                    <p className="text-green-700 leading-relaxed whitespace-pre-line">{faq.answer}</p>
                  </div>
                </details>
              </div>
            ))}
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="bg-green-800/30 backdrop-blur-sm rounded-lg p-4 sm:p-6 lg:p-8 border border-green-400/30 shadow-xl">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="flex items-center space-x-3 text-green-100 text-sm sm:text-base">
                    ...
                    <span>{t('contact.info.collegeLocation')}</span>
                  </div>
                  <div className="flex items-center space-x-3 text-green-100 text-sm sm:text-base">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-green-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="bg-green-800/30 backdrop-blur-sm rounded-lg p-4 sm:p-6 lg:p-8 border border-green-400/30 shadow-xl">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <a href="https://wa.me/+919488505516" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center p-3 sm:p-4 bg-green-600/30 rounded-lg hover:bg-green-500/50 transition-colors border border-green-400/30 group">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-green-300 group-hover:text-white mb-1 sm:mb-2" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-xs text-green-200 group-hover:text-white text-center">{t('contact.social.whatsapp')}</span>
                  </a>
                </div>
      ...
      <footer className="relative bg-black">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            {/* Hackathon Info */}
            <div>
              <h3 className="text-white font-medium mb-4 text-sm uppercase tracking-wider">{t('footer.hackathonInfo')}</h3>
              <ul className="space-y-3">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              ...
              <p className="text-green-200/50 text-xs mt-1">
                {t('footer.organizerInfo')}
              </p>
            </div>
            
            <div className="flex space-x-6 text-xs">
              <a href="#" className="text-green-200/60 hover:text-green-200 transition-colors duration-300">{t('footer.privacyPolicy')}</a>
              <a href="#" className="text-green-200/60 hover:text-green-200 transition-colors duration-300">{t('footer.termsOfService')}</a>
              <a href="#" className="text-green-200/60 hover:text-green-200 transition-colors duration-300">{t('footer.codeOfConduct')}</a>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-green-800/30">
            <div className="text-center">
              <p className="text-green-200/70 text-sm font-medium">{t('footer.collegeFullName')}</p>
              <p className="text-green-200/50 text-xs mt-1">
                {t('footer.collegeAddress')}
              </p>
            </div>
          </div>
        </div>
